...
const file_executor_proto_rawDesc = "" +
	...
	"\x11execution_time_ms\x18\x06 \x01(\tR\x0fexecutionTimeMs2\\\n" +
	"\x0fExecutorService\x12I\n" +
	"\x12ExecuteAndValidate\x12\x18.executor.ExecuteRequest\x1a\x19.executor.ExecuteResponseB<Z:github.com/FA25SE050-RogueLearn/RogueLearn.Executor/protosb\x06proto3"
...
var (
	file_executor_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
	file_executor_proto_goTypes  = []any{
...
var file_executor_proto_depIdxs = []int32{
	...
	1, // 1: executor.ExecutorService.ExecuteAndValidate:input_type -> executor.ExecuteRequest
	2, // 2: executor.ExecutorService.ExecuteAndValidate:output_type -> executor.ExecuteResponse
