...
const (
	ExecutorService_ExecuteAndValidate_FullMethodName = "/executor.ExecutorService/ExecuteAndValidate"
)
...
type ExecutorServiceClient interface {
	ExecuteAndValidate(ctx context.Context, in *ExecuteRequest, opts ...grpc.CallOption) (*ExecuteResponse, error)
}
...
func (c *executorServiceClient) ExecuteAndValidate(ctx context.Context, in *ExecuteRequest, opts ...grpc.CallOption) (*ExecuteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ExecuteResponse)
	err := c.cc.Invoke(ctx, ExecutorService_ExecuteAndValidate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExecutorServiceServer interface {
	ExecuteAndValidate(context.Context, *ExecuteRequest) (*ExecuteResponse, error)
...
func (UnimplementedExecutorServiceServer) ExecuteAndValidate(context.Context, *ExecuteRequest) (*ExecuteResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExecuteAndValidate not implemented")
}
...
func _ExecutorService_ExecuteAndValidate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExecuteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExecutorServiceServer).ExecuteAndValidate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExecutorService_ExecuteAndValidate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExecutorServiceServer).ExecuteAndValidate(ctx, req.(*ExecuteRequest))
	}
...
var ExecutorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ExecuteAndValidate",
			Handler:    _ExecutorService_ExecuteAndValidate_Handler,
		},
	},
